...
func (a DBAdapter) ExecContext(ctx context.Context, query string, args ...any) (qc.Result, error) {
...
// ExecContext выполняет запрос, не возвращающий строк.
// EN: ExecContext executes a query that does not return rows.
func (a TxAdapter) ExecContext(ctx context.Context, query string, args ...any) (qc.Result, error) {
...
// QueryRowContext выполняет запрос, возвращающий одну строку.
// EN: QueryRowContext executes a query that returns a single row.
func (a TxAdapter) QueryRowContext(ctx context.Context, query string, args ...any) qc.Row {
