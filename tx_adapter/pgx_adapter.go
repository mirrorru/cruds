...
func (a PGXAdapter) ExecContext(ctx context.Context, query string, args ...any) (qc.Result, error) {
...
func (a PGXAdapter) QueryContext(ctx context.Context, query string, args ...any) (qc.Rows, error) {
...
func (a PGXAdapter) QueryRowContext(ctx context.Context, query string, args ...any) qc.Row {
...
// ExecContext выполняет запрос, не возвращающий строк.
// EN: ExecContext executes a query that does not return rows.
func (a PGXTxAdapter) ExecContext(ctx context.Context, query string, args ...any) (qc.Result, error) {
...
// QueryContext выполняет запрос, возвращающий строки.
// EN: QueryContext executes a query that returns rows.
func (a PGXTxAdapter) QueryContext(ctx context.Context, query string, args ...any) (qc.Rows, error) {
...
// QueryRowContext выполняет запрос, возвращающий одну строку.
// EN: QueryRowContext executes a query that returns a single row.
func (a PGXTxAdapter) QueryRowContext(ctx context.Context, query string, args ...any) qc.Row {
