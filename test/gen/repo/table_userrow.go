...
func (t *TableUserRow) One(ctx context.Context, tx contracts.TxProcessor, struct_info.Keys ...any) (*model.UserRow, error) {
	buf := new(model.UserRow)
	refs := t.scanRefs(buf)
...
func (t *TableUserRow) Del(ctx context.Context, tx contracts.TxProcessor, struct_info.Keys ...any) (contracts.Result, error) {
