//go:generate crudsgen -src=.:* -dest=test/gen/repo -pkg=repo
...
func (t *TableProductRow) One(ctx context.Context, tx contracts.TxProcessor, struct_info.Keys ...any) (*model.ProductRow, error) {
	buf := new(model.ProductRow)
	refs := t.scanRefs(buf)
...
func (t *TableProductRow) Del(ctx context.Context, tx contracts.TxProcessor, struct_info.Keys ...any) (contracts.Result, error) {
