...
func TestGetTableInfo(t *testing.T) {
	...
	tests := []struct {
		...
		{reflectType: reflect.TypeOf(samples.TwoKey{}),
			...
			}, PKIdxList: []int{0, 1}, InsertIdxList: []int{0, 1}, UpdateIdxList: []int{}, SelectIdxList: []int{0, 1}, SortIdxList: []int(nil), RefIdxList: []int(nil)}},
		{reflectType: reflect.TypeOf(samples.TwoFields{}),
			...
			}, PKIdxList: []int{}, InsertIdxList: []int{0, 1}, UpdateIdxList: []int{0, 1}, SelectIdxList: []int{0, 1}, SortIdxList: []int(nil), RefIdxList: []int(nil)}},
		{reflectType: reflect.TypeOf(samples.TwoCombo1Smpl{}),
			...
			}, PKIdxList: []int{0, 1}, InsertIdxList: []int{0, 1, 2, 3}, UpdateIdxList: []int{2, 3}, SelectIdxList: []int{0, 1, 2, 3}, SortIdxList: []int(nil), RefIdxList: []int(nil)}},
		{reflectType: reflect.TypeOf(samples.TwoCombo2Smpl{}),
			...
			}, PKIdxList: []int{0, 1}, InsertIdxList: []int{0, 1, 2}, UpdateIdxList: []int{2}, SelectIdxList: []int{0, 1, 2}, SortIdxList: []int(nil), RefIdxList: []int(nil)}},
